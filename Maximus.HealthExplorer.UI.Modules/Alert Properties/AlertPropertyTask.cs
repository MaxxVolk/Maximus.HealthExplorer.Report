...
namespace Maximus.HealthExplorer.UI.Modules
{
  ...
  public class AlertPropertyTask : INotifyPropertyChanged, INotifyInitialized
  {
    private string connectionSessionTicket;
    private Microsoft.EnterpriseManagement.Presentation.DataAccess.IDataObject entity;
    ...
    */
    ...
    public Microsoft.EnterpriseManagement.Presentation.DataAccess.IDataObject Entity
    {
      get => entity;
      set
      {
